...
#[cfg(feature = "util")]
use sevenz_turbo::decompress_file;
use sevenz_turbo::{Archive, ArchiveReader, BlockDecoder, Password};
#[cfg(feature = "util")]
...
fn build_archive_with_entry_name(name: &str) -> Vec<u8> {
    ...
    use sevenz_turbo::{ArchiveEntry, ArchiveWriter};
...
fn default_entry_extract_fn_rejects_parent_dir_component() {
    use sevenz_turbo::{ArchiveEntry, default_entry_extract_fn};
...
/// Regression test for <https://github.com/hasenbanck/sevenz-turbo/issues/127>.
#[test]
